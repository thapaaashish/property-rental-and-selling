    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="background: #f3f4f6; padding: 16px; border-radius: 8px; margin: 16px 0;">
          <h3 style="margin-top: 0;">${bookingDetails.listing.title}</h3>
...
// New function for agent notification
  ...
  const mailOptions = {
    ...
    html: `
        <div>
          ...
          <p><strong>From:</strong> ${bookingDetails.user.fullname}</p>
          <p><strong>Guest Email:</strong> ${bookingDetails.user.email}</p>
