...
import { Users, Lock, Unlock, Info, Filter, Search } from "lucide-react";
...
const UsersTab = ({
  ...
  const handleBanToggle = async (userId, ban) => {
    try {
      ...
      console.error("Error in handleBanToggle:", error.response || error);
      setPopupMessage(
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <div className="flex space-x-2">
                        <button
                          ...
                          aria-label={`View user ${user.fullname || user._id}`}
                        >
                          View
                        </button>
                        <button
